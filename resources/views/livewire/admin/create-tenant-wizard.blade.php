            ...
            <div class="space-y-8">
                ...
                <div class="p-4 rounded-lg border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-700/50">
                    ...
                    <div class="flex gap-6">
                        {{-- Sidebar Claro --}}
                        <div class="flex-1">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-2 text-center">Modo Claro</p>
                            <div class="w-full max-w-[200px] mx-auto rounded-lg overflow-hidden shadow-lg border border-gray-200">
                                {{-- Header del sidebar con logo --}}
                                <div class="p-3 border-b" style="background-color: {{ $color_primary }};">
                                    <div class="flex items-center gap-2">
                                        @if($logo || $svg_logo)
                                            <div class="w-8 h-8 bg-white/20 rounded flex items-center justify-center overflow-hidden">
                                                @if($logo)
                                                    <img src="{{ $logo->temporaryUrl() }}" alt="Logo" class="max-w-full max-h-full object-contain">
                                                @elseif($svg_logo)
                                                    <div class="w-6 h-6 text-white">{!! $svg_logo !!}</div>
                                                @endif
                                            </div>
                                        @else
                                            <div class="w-8 h-8 bg-white/20 rounded flex items-center justify-center">
                                                <span class="text-white font-bold text-sm">{{ substr($company_name ?: 'E', 0, 1) }}</span>
                                            </div>
                                        @endif
                                        <span class="text-white font-semibold text-sm truncate">{{ $company_name ?: 'Empresa' }}</span>
                                    </div>
                                </div>
                                {{-- Items del menú --}}
                                <div class="bg-white p-2 space-y-1">
                                    <div class="px-3 py-2 rounded text-white text-xs font-medium" style="background-color: {{ $color_primary }};">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                                            Dashboard
                                        </span>
                                    </div>
                                    <div class="px-3 py-2 rounded text-gray-600 text-xs hover:bg-gray-100">
                                        <span class="flex items-center gap-2">
                                ...
                                <div class="p-2 border-t bg-gray-50">
                                    <div class="text-xs text-gray-500 truncate text-center">{{ $company_name ?: 'Empresa' }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Sidebar Oscuro --}}
                        <div class="flex-1">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-2 text-center">Modo Oscuro</p>
                            <div class="w-full max-w-[200px] mx-auto rounded-lg overflow-hidden shadow-lg border border-slate-700" style="background-color: {{ $color_secondary }};">
                                {{-- Header del sidebar con logo --}}
                                <div class="p-3 border-b border-white/10" style="background-color: {{ $color_primary }};">
                                    <div class="flex items-center gap-2">
                                        @if($logo || $svg_logo)
                                            <div class="w-8 h-8 bg-white/20 rounded flex items-center justify-center overflow-hidden">
                                                @if($logo)
                                ...
                                <div class="p-2 space-y-1">
                                    ...
                                    <div class="px-3 py-2 rounded text-gray-300 text-xs hover:bg-white/10">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                            Documentos
                                        </span>
                                ...
                                <div class="p-2 border-t border-white/10">
                                    <div class="text-xs text-gray-400 truncate text-center">{{ $company_name ?: 'Empresa' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
