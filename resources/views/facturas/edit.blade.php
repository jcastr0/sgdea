...
<div class="form-container">
    <div class="form-header">
        <h1>Editar Factura #{{ $factura->numero_factura }}</h1>
    ...
    >
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('fecha_factura', $factura->fecha_factura->format('Y-m-d\TH:i')) }}"
                        required
                    >
                    @error('fecha_factura')
                        <span class="invalid-feedback">{{ $message }}</span>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="total-display">
                    <span>$</span>
                    <span id="totalPagar">{{ number_format($factura->total_pagar, 2) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('facturas.show', $factura) }}" class="btn btn-outline btn-lg">Cancelar</a>
        </div>
    </form>
</div>
